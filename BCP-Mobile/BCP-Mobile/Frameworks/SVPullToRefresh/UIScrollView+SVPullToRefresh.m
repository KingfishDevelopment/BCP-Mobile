...
- (void)rotateArrow:(float)degrees hide:(BOOL)hide {
    [UIView animateWithDuration:0.2 delay:0 options:UIViewAnimationOptionAllowUserInteraction animations:^{
        ...
        transform = CATransform3DScale(CATransform3DIdentity, 0.75, 0.75, 0.75);
        transform = CATransform3DRotate(transform, degrees, 0, 0, 1);
        self.arrow.layer.transform = transform;
        //self.arrow.layer.transform = CATransform3DScale(CATransform3DRotate(CATransform3DIdentity, degrees, 0, 0, 1), 0.5, 0.5, 1);
