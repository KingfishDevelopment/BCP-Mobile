...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [topLabel setTextColor:[UIColor BCPOffBlackColor]];
        ...
        UIImageView *icon = [[UIImageView alloc] initWithFrame:CGRectMake(BCP_ICON_SIZE, topLabel.frame.size.height+10, BCP_ICON_SIZE, BCP_ICON_SIZE)];
        ...
        [bottomLabel setTextColor:[UIColor BCPOffBlackColor]];
